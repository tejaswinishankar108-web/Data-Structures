#Stacks can be implemented with the help of arrays as well, i.e., in python they are lists.
...
class Stack():
    ...
    #  by using the built-in length functionality of arrays
    def peek(self):
        return self.array[len(self.array)-1]

    #For push operation, we use the built-in append method of lists, which appends/pushes/inserts an element at the end 
...
my_stack = Stack()
my_stack.push("Artificial Intelligence")
...
print(my_stack.__dict__)#__dict__ is a built-in attribute of classes in Python that returns a dictionary containing the class's attributes and their values.
#{'array': ["Artificial Intelligence", 'Courses']}
